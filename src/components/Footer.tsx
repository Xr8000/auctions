    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">AuctionHouse</h3>
            <p className="text-sm">
              Your trusted platform for unique and valuable items.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/auctions" className="hover:text-white transition-colors duration-200">Auctions</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/impressum" className="hover:text-white transition-colors duration-200">Impressum</Link></li>
              <li><Link to="/datenschutz" className="hover:text-white transition-colors duration-200">Datenschutz</Link></li>
            </ul>
          </div>
